    ...
    <div className="min-h-screen w-full flex font-sans bg-white">
      ...
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center p-10 md:p-16 relative">
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <form onSubmit={handleAuth} className="space-y-44">
            ...
            {tab === 'signin' && (
              <div className="flex items-center justify-between text-sm pt-24 pb-44">
            ...
            {/* Toggle Link */}
            <div className="text-center text-sm text-gray-500 mt-44 mb-36">
            ...
            <div className="flex flex-col gap-28 mt-52">
