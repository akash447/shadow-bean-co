      ...
      <div className="w-full md:w-1/2 bg-[#FAF8F5] flex items-center justify-center p-6">
        <div className="w-full max-w-[360px]">
          ...
          <div className="md:hidden flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#1c0d02]" style={{ fontFamily: "'Agdasima', sans-serif" }}>
                Shadow Bean Co.
              </h2>
              <p className="text-[#1c0d02]/50 text-[10px] tracking-wide">Your coffee, your way</p>
            </div>
          </div>
          ...
          <div className="flex bg-gray-100 rounded-xl p-1 mb-4">
            {(['signin', 'register'] as Tab[]).map((t) => (
              <button
                ...
                className={`flex-1 py-1.5 text-xs font-semibold rounded-lg transition-all duration-200 ${tab === t
          ...
          {message === 'login_required' && (
            <div className="bg-blue-50 border border-blue-100 text-blue-700 text-xs rounded-lg px-3 py-2 mb-3">
          ...
          <AnimatePresence>
            {error && (
              <motion.div
                ...
                className="bg-red-50 border border-red-100 text-red-600 text-xs rounded-lg px-3 py-2 mb-3"
              >
                {error}
              </motion.div>
            )}
          ...
          <div className="flex items-center my-3">
            ...
            <span className="px-3 text-[10px] text-gray-400 uppercase tracking-widest font-medium">or</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
