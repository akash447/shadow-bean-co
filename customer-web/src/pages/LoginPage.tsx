    ...
    <div className="min-h-screen w-full flex font-sans bg-white">
      ...
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center p-10 md:p-16 relative">
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <form onSubmit={handleAuth} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            {tab === 'signin' && (
              <div className="flex items-center justify-between text-sm" style={{ paddingTop: '16px', paddingBottom: '16px' }}>
            ...
            <AnimatePresence>
              {error && (
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="text-red-500 text-sm bg-red-50 p-2 rounded">
                  {error}
                </motion.div>
              )}
            </AnimatePresence>
            ...
            {/* Toggle Link */}
            <div className="text-center text-sm text-gray-500" style={{ marginTop: '8px', marginBottom: '8px' }}>
