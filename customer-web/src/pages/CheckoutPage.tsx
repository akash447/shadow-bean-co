...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#FAF8F5]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-3 md:py-10">
        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
          ...
          <motion.button
            ...
            className="w-full py-3 md:py-4 bg-[#1c0d02] text-white rounded-xl font-bold text-sm md:text-base hover:bg-[#2a1a0a] transition-colors disabled:opacity-50 uppercase tracking-wider"
          >
