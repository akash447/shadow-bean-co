...
var _firebaseApp = require("./firebaseApp.js");
...
function eventsSendEvent(eventName, eventBody) {
  ...
  setImmediate(() => _reactNative.DeviceEventEmitter.emit('rnfb_' + eventName, eventBody));
}
...
var _default = exports.default = {
  ...
  async initializeApp(options, appConfig) {
    ...
    const existingApp = (0, _firebaseApp.getApps)().find(app => app.name === name);
    if (existingApp) {
      return {
        options,
        appConfig
    ...
    (0, _firebaseApp.initializeApp)(optionsCopy, newAppConfig);
    return {
      options,
      appConfig
    };
  ...
  setLogLevel(logLevel) {
    (0, _firebaseApp.setLogLevel)(logLevel);
  },
  /**
  ...
  setAutomaticDataCollectionEnabled(appName, enabled) {
    (0, _firebaseApp.getApp)(appName).automaticDataCollectionEnabled = enabled;
  },
  /**
  ...
  async deleteApp(appName) {
    if ((0, _firebaseApp.getApp)(appName)) {
      await (0, _firebaseApp.deleteApp)((0, _firebaseApp.getApp)(appName));
    }
  },
  /**
   * Gets the meta data.
