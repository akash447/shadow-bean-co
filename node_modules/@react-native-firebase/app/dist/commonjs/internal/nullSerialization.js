...
exports.encodeNullValues = encodeNullValues;
/*
 ...
 */
function encodeNullValues(data) {
  if (data === null) {
  ...
  function processArrayChild(child, encoded, index, stack) {
    if (child === null) {
  ...
  function processObjectChild(child, encoded, key, stack) {
    if (child === null) {
...
//# sourceMappingURL=nullSerialization.js.map