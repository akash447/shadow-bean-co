...
export default function AboutScreen() {
    ...
    const renderContent = () => (
        <>
            ...
            <View style={[styles.block, { height: BLOCK_HEIGHT }, isWeb && styles.webBlock]}>
                {isWeb ? (
                    <View
                        style={{
                            width: '100%',
                            ...
                            backgroundImage: `url(${aboutHeroBg.uri})`,
            ...
            <View style={[styles.block, styles.blockCream, { height: BLOCK_HEIGHT }, isWeb && styles.webBlock]}>
...
const styles = StyleSheet.create({
    ...
    footerLogo: {
        ...
        height: 36,
        marginBottom: 8,
        tintColor: '#2C2724', // Use dark tint for cream background
    },
    footerBrand: {
        color: '#2C2724',
        fontSize: 12,
